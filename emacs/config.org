...
- [[#programs-to-load][PROGRAMS TO LOAD]]
  ...
  - [[#company][company]]
  - [[#dired][dired]]
- [[#ivy-autocomplete-tool][IVY autocomplete Tool]]
- [[#theme][THEME]]
- [[#fonts][FONTS]]
- [[#backups][BACKUPS]]
- [[#varia][VARIA]]
  - [[#dashboard-funcs][Dashboard funcs]]
  - [[#guiline-numbers][GUI+Line numbers]]
  - [[#language-support][LANGUAGE SUPPORT]]
  - [[#orgmodestuff][orgmodeStuff]]
  - [[#orgmode-indentation][orgmode indentation]]
  - [[#auto-blocks-mode][auto Blocks mode]]
  - [[#reload-initfile][reload Initfile]]
- [[#shells-and-terms][Shells and terms]]
  - [[#eshellactual-shell][Eshell(actual shell)]]
  - [[#vterm-terminal-emulator][vterm (terminal emulator)]]
  - [[#vterm-toggle][Vterm-toggle]]
- [[#sudo-edit][Sudo edit]]
- [[#all-the-icons][ALL THE ICONS]]
- [[#dashboard][DASHBOARD]]
- [[#applaucnher][APPLAUCNHER]]
  - [[#counsel-app-launcher][Counsel-App Launcher]]
...
* FONTS
Definining all Fonts emacs will use
...
#+end_src
** auto Blocks mode
This is huge with <s,<e, etc really usefull
#+begin_src emacs-lisp
 (require 'org-tempo)
#+end_src
